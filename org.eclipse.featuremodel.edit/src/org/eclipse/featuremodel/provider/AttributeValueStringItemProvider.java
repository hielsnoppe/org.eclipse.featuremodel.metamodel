...
/**
 * This is the item provider adapter for a {@link org.eclipse.featuremodel.AttributeValueString} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeValueStringItemProvider
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_AttributeValueString_value_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_AttributeValueString_value_feature", "_UI_AttributeValueString_type"),
         FeatureModelPackage.Literals.ATTRIBUTE_VALUE_STRING__VALUE,
         true,
         false,
         false,
  ...
  public String getText(Object object) {
    String label = ((AttributeValueString)object).getValue();
  ...
  public void notifyChanged(Notification notification) {
    ...
    switch (notification.getFeatureID(AttributeValueString.class)) {
      case FeatureModelPackage.ATTRIBUTE_VALUE_STRING__VALUE:
