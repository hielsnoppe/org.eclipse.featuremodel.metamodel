...
public class FeaturemodelPackageImpl extends EPackageImpl implements FeaturemodelPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getConstraint_Code(), ecorePackage.getEString(), "code", null, 1, 1, Constraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
