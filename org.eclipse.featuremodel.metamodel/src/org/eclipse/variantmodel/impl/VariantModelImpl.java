 ...
 *   <li>{@link org.eclipse.variantmodel.impl.VariantModelImpl#getName <em>Name</em>}</li>
...
public class VariantModelImpl extends EObjectImpl implements VariantModel {
  ...
  /**
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VariantModelPackage.VARIANT_MODEL__NAME, oldName, name));
	}
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case VariantModelPackage.VARIANT_MODEL__VERSION:
				return getVersion();
			case VariantModelPackage.VARIANT_MODEL__NAME:
				return getName();
			case VariantModelPackage.VARIANT_MODEL__ATTRIBUTES:
